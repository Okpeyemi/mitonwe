...
import { MoreVertical, Star, ExternalLink, Share2, Shredder } from "lucide-react";
      ...
      <table className="w-full">
        <thead>
          <tr className="bg-secondary-foreground text-secondary">
            ...
            <th className="text-left p-3 font-medium">Modification le</th>
            <th className="text-left p-3 font-medium">Qui peut accéder</th>
